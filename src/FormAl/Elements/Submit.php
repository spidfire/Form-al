...
class Submit extends ElementBase
{
    ...
    public function render()
    {
        ...
        $element->attr('onclick', "if(this.getAttribute('rel')=='submitted'){return false;};this.setAttribute('rel','submitted');var scope = this;setTimeout(function(){scope.removeAttribute('rel')}, 3000);");
